import { Location, SSAForm } from 'decompiler/analysis/ssa';
import * as Expr from 'decompiler/expr/base';
import { DataType, Func, Method, PointerType, TypeProperty } from 'decompiler/typesys';
...
export class CodeBuilder {
    ...
    private renderAnnotation(annotation: SourceAnnotation) {
        let str = '';
        if (this.m_currentColumn === 1) {
            str += ' '.repeat(this.m_options.tabWidth * this.m_indent);
        }
